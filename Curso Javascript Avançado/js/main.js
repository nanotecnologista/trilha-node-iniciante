...
function setList(list) {
    ...
    for (var key in list) {
        table += '<tr><td>' + formatDesc(list[key].desc) + '</td><td>' + formatAmount(list[key].amount) + '</td><td>' + formatValue(list[key].value) + '</td><td><button class="btn bnt-default" onclick="setUpdate(' +key+');" >Edit</button> <button class="btn bnt-default" onclick="deleteData(' +key+');" >Delete</button></td></tr>';
    }
    table += '</tbody>';
